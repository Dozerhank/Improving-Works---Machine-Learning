...
{
    internal class IrisLab : Lab<IrisData>
    {
        ...
        public override void SetupAndTrainModel()
        {
            ...
            Trainer = MlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(labelColumnName: "KeyColumn", featureColumnName: "Features")
